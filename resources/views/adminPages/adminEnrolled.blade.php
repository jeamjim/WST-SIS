          ...
          <div class="card-header pb-0">
            ...
            <a href="{{ route('enrollment.create') }}">
              <button class="btn btn-success btn-sm rounded-pill px-3" data-bs-toggle="modal" data-bs-target="#addStudentModal">
                <i class="fas fa-user-plus"></i> Enrollment Student
              </button>
            </a>
          </div>
            ...
            <div class="table-responsive p-0">
              <table id="myDataTable" class="table align-items-center mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>   
                        <h6 class="mb-0 text-sm">{{ $enroll->id }}</h6>
                    </td>
                    <td>
                    <div class="d-flex px-2 py-1">
                        <div>
                          <img src="../assets/img/enroll.jpg" class="avatar avatar-sm me-3" alt="user1">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="badge badge-sm bg-gradient-primary">{{ $enroll->student?->name ?? 'N/A' }}</h6>
                        </div>
                      </div>
                    </td>
                    <td class="align-middle text-center text-sm">
                      <span class="text-secondary text-xs font-weight-bold">{{ $enroll->subject?->name ?? 'N/A' }}</span>
                    </td>
                    <td class="align-middle text-center">
                      <span class="text-secondary text-xs font-weight-bold">{{ $enroll->enrollment_date }}</span>
                    </td>
